...
function TicketForm() {
  return (
    <Form style={{background:'#151515'}} className='buyTicketForm'>
            ...
            <h4 id="book5"className="bookButton"><a href='https://bit.ly/tedx-group-5' target='_blank'><b>BOOK IN A GROUP OF 5:</b><br/>10% discount</a></h4>
            ...
            <h4 id="book10" className="bookButton"><a href='https://bit.ly/tedx-group-10' target='_blank'><b>BOOK IN A GROUP OF 10:</b><br/>20% discount</a></h4>
            </div>
        </Form>
  )
}
